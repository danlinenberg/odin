import type { DetectedPort } from "@odin/port-scanner";
import type { AgentIdentity } from "@odin/shared/agent-identity";
import type { FsWatchEvent } from "@odin/workspace-fs/host";
...
export interface AgentLifecycleMessage {
	...
	terminalId: string;
	// Absent when the hook ran without `ODIN_AGENT_ID` set (legacy shells
