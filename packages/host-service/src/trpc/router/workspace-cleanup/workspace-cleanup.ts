...
import { sanitizePromptForPty } from "@odin/shared/agent-prompt-launch";
...
export const workspaceCleanupRouter = router({
	 ...
	 * visible and delete can be retried instead of orphaning disk state.
	 *
...
async function runDestroy(
	...
	// The local row is the commit point and the only record.
