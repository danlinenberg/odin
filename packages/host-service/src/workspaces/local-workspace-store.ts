...
/**
 * Field names mirror `HostServiceContext` so a full request context
...
/**
 * Wire shape the workspace procedures return: the local row plus the host
 * and organization identifiers the renderer expects alongside it.
 */
