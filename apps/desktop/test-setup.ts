...
const testTmpDir = join(tmpdir(), "odin-test");
...
// =============================================================================
// @odin/local-db Schema Mock (drizzle-orm/sqlite-core not available in Bun tests)
// =============================================================================
...
const localDbMock = () => ({
	...
	slackReactions: mockTable("slack_reactions"),
	workLog: mockTable("work_log"),
...
mock.module("@odin/local-db", localDbMock);
mock.module("@odin/local-db/schema", localDbMock);
