import { chatServiceTrpc } from "@odin/chat-legacy/client";
import { Badge } from "@odin/ui/badge";
import { Button } from "@odin/ui/button";
import {
	Collapsible,
	CollapsibleContent,
	CollapsibleTrigger,
} from "@odin/ui/collapsible";
import { claudeIcon } from "@odin/ui/icons/preset-icons";
