							...
							<span
								title={
									load.busy
										...
										: `Room for about ${load.roomForMore} more session(s): ${load.agentCount} running, holding ${load.agentMemoryGb} GB, budgeting ~${SESSION_MEMORY_GB} GB each, against ${AGENT_MEMORY_BUDGET_PERCENT}% of this Mac's RAM. Agents are using ${load.agentCpuPercent}% of the CPU · machine load ${load.cpuPercent}%.`
								}
								className={cn(
