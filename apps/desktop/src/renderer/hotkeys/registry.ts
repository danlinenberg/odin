...
export const HOTKEYS_REGISTRY = {
	...
	ODIN_SLACK: {
		...
		label: "Slack",
		category: "Navigation",
		description: "Open my :eyes: Slack reactions",
	},
	ODIN_INSIGHTS: {
		key: { mac: L("i"), windows: L("i"), linux: L("i") },
		label: "Insights",
		category: "Navigation",
		description: "What lands on you and what you do with it",
	},
	ODIN_SESSIONS: {
	...
	ODIN_TASKS: {
		key: { mac: L("t"), windows: L("t"), linux: L("t") },
		label: "My Tasks",
		category: "Navigation",
		description: "Open my own task list",
	},
	ODIN_JIRA: {
		key: { mac: L("j"), windows: L("j"), linux: L("j") },
		label: "My Jira",
		category: "Navigation",
		description: "Open my Jira issues",
	},
	ODIN_PRS: {
		key: { mac: L("p"), windows: L("p"), linux: L("p") },
		label: "GitHub",
		category: "Navigation",
		description: "Open my pull requests",
	},
	ODIN_NOTION: {
		key: { mac: L("n"), windows: L("n"), linux: L("n") },
		label: "Notion",
		category: "Navigation",
	...
	ODIN_NEW_TASK: {
		key: {
			mac: L("meta+shift+a"),
			windows: L("ctrl+shift+alt+a"),
			linux: L("ctrl+shift+alt+a"),
		},
		label: "New Task",
		category: "Navigation",
