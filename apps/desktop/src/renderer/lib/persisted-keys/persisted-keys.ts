...
export const DEAD_KEYS: DeadKey[] = [
	...
	// Adaptive-layout toggle removed; shortcuts always follow key labels
	{ key: "keyboard-preferences", match: "exact" },
	// Ringtone picker removed; the single notification sound is not selectable
	{ key: "ringtone-storage", match: "prefix" },
	...
	// Stores with no reachable importer, deleted with the rest of the dead tree
