import { generateTitleFromMessage } from "@odin/chat-legacy/server/desktop";
import { getSmallModel } from "@odin/chat-legacy/server/shared";
import { workspaces } from "@odin/local-db";
import { deriveWorkspaceTitleFromPrompt } from "@odin/shared/workspace-launch";
