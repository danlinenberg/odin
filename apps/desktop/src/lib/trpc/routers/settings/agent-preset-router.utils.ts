import { PROMPT_TRANSPORTS } from "@odin/local-db";
import type { AgentDefinition } from "@odin/shared/agent-catalog";
import type {
	AgentPresetPatch,
	CustomAgentDefinitionPatch,
} from "@odin/shared/agent-settings";
import { validateTaskPromptTemplate } from "@odin/shared/agent-settings";
