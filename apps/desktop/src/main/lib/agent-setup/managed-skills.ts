...
export const MANAGED_SKILL_MARKER = "<!-- odin-managed-skill v1 -->";

/**
 * Sentinel file marking a directory as Odin-managed (used for the Claude
 * plugin dir, whose manifest is JSON and can't carry the markdown marker).
 */
export const MANAGED_SENTINEL_NAME = ".odin-managed";

/** Namespace subdirectory for managed commands under ~/.agents/commands. */
export const MANAGED_COMMAND_NAMESPACE = "odin";
 ...
 */
const CLAUDE_PLUGIN_DIR_NAME = "odin";
