...
import * as schema from "@odin/local-db";
...
import {
	ensureOdinHomeDirExists,
	ODIN_HOME_DIR,
	ODIN_SENSITIVE_FILE_MODE,
} from "../app-environment";

const DB_PATH = join(ODIN_HOME_DIR, "local.db");
...
try {
	chmodSync(DB_PATH, ODIN_SENSITIVE_FILE_MODE);
} catch {
