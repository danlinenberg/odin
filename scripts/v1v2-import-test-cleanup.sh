...
DEV_DATA_LOCAL_DB="$(pwd)/odin-dev-data/local.db"
SATYA_TEST_HOST_DB="$(pwd)/odin-dev-data/host/$SATYA_TEST_ORG/host.db"
ODIN_HOST_DB="$(pwd)/odin-dev-data/host/$ODIN_ORG/host.db"
